...
#             1,2,3 coefficients A TIME
        ...
        case 12:
            ...
            n_param = len(alphas) # Here n_param has a different meaning. It is the \
                                  # number of realizations of Fourier coefficients 
                                  # used to generate the whole dataset
            mu_space = [alphas,time]
